...
var connector = addBall(-17, 10, 0);
var connector1 = addBall(5, 10, 0);
var mount = addBall(-23, 10, 0);
var mount1 = addBall(-1, 10, 0);
...
lgeometry.vertices.push(new THREE.Vector3( -17, 10, 0) );
lgeometry.vertices.push(new THREE.Vector3( -1, 10, 0) );
var sline = new THREE.Line(lgeometry,  new THREE.LineBasicMaterial({color: "blue"}));
scene.add(sline);

var lgeometry1 = new THREE.Geometry();
lgeometry1.vertices.push(new THREE.Vector3( 5, 10, 0) );
lgeometry1.vertices.push(new THREE.Vector3( 19, 10, 0) );
