...
var lampBulb = new THREE.Mesh(lampBulbGeom, new THREE.MeshPhongMaterial({color: "yellow", transparent: false, opacity: 0.5, shininess: 500}));
...
var wire = new THREE.Line(wirePoints, new THREE.LineBasicMaterial({color: "yellow"}));
scene.add(wire);

var lgeometry = new THREE.Geometry();
lgeometry.vertices.push(new THREE.Vector3( -14, 14, 0) );
lgeometry.vertices.push(new THREE.Vector3( 10, 14, 0) );

var sline = new THREE.Line(lgeometry,  new THREE.LineBasicMaterial({color: "yellow"}));
scene.add(sline);

var lgeometry1 = new THREE.Geometry();
lgeometry1.vertices.push(new THREE.Vector3( -12, 10, 0) );
lgeometry1.vertices.push(new THREE.Vector3( 8, 10, 0) );
